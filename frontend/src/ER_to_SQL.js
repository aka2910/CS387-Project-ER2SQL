...
import {Entity, Attribute, Relation, ER} from './ER.js';
import {convert_json_to_ER} from './json_convert.js';
import {convertToStructuredJson} from './parsed_to_structured.js';
import {Table, Foreign_Key} from './Schema.js';


function ER_to_SQL(frontend_json){
    var Parsed_Json = convertToStructuredJson(frontend_json);
    var er = convert_json_to_ER(Parsed_Json);
    Vertices = [];
    Edges = [];
    var table_map = {};
